...
def add_type_ignore_to_loguru_imports(filepath: str) -> None:
    ...
    Appends `# type: ignore` to `from loguru import logger` import statements and to all calls to `logger.debug`, `logger.info`, `logger.warning`, `logger.error`, and `logger.critical` within the specified file to suppress type checking errors. The file is modified in place.
    """
