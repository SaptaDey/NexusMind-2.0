...
def extract_clean_stage4_evidence():
    ...
    Reads the original file, replaces tabs with four spaces, removes trailing whitespace, and inserts newlines between certain adjacent statements to address syntax errors. The cleaned content is saved to a new file with a `.clean` extension. Prints a confirmation message on success or an error message if an exception occurs.
    """
