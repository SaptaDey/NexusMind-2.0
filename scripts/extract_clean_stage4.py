...
def extract_clean_stage4_evidence():
    """
    Cleans and reformats the stage_4_evidence.py file by normalizing indentation and spacing.
    
    Reads the original file, replaces tabs with four spaces, removes trailing whitespace, and inserts newlines between certain adjacent statements to address syntax issues. The cleaned content is saved to a new file with a `.clean` extension. Prints a message indicating success or failure.
    """
