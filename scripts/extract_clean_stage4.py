...
def extract_clean_stage4_evidence():
    ...
    Reads the original file, replaces tabs with four spaces, removes trailing whitespace, and inserts newlines between certain adjacent statements to address syntax errors. Writes the cleaned content to a new file with a `.clean` extension in the same directory. Prints a success message upon completion or an error message if processing fails.
    """
