...
def fix_indentation_issues(filepath: str) -> None:
    """
    Cleans up indentation and trailing whitespace in a Python file.
    
    Reads the specified file, replaces all tab characters with four spaces, removes trailing whitespace from each line, and writes the cleaned content back to the file.
    """
    try:
