...
def fix_indentation_issues(filepath: str) -> None:
    """
    Cleans up a Python file by replacing tabs with spaces and removing trailing whitespace.
    
    Reads the specified file, replaces each tab character with four spaces, strips trailing whitespace from every line, and writes the cleaned content back to the file.
    """
    try:
