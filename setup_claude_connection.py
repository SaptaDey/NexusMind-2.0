...
def display_instructions():
    ...
    Provides both import and manual setup guidance, including configuration file location, endpoint details, and a reference to full documentation.
    """
    logger.info("\n" + "=" * 60)
...
def main():
    """
    Runs the NexusMind MCP setup workflow, verifying server health, MCP endpoint functionality, configuration validity, and displaying connection instructions.
    
    Exits the program if the NexusMind server is not running. This function orchestrates the setup process to ensure Claude Desktop can connect to the NexusMind MCP server.
    """
    logger.info("\n=== NexusMind MCP Setup ===\n")
