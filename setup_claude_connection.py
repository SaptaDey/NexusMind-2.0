...
def check_health():
    """
    Checks whether the NexusMind server is operational by querying its health endpoint.
...
def display_instructions():
    ...
    The instructions include both importing the configuration file and manual setup details, along with a reference to the full documentation.
    """
    logger.info("\n" + "=" * 60)
...
def main():
    ...
    Performs each setup step in sequence and exits if the server is not running.
    """
    logger.info("\n=== NexusMind MCP Setup ===\n")
