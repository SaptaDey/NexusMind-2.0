...
async def mcp_handler(request: Request):
    """
    Handles JSON-RPC 2.0 requests for the MCP server, processing supported methods and returning appropriate responses.
    ...
    Returns a JSON-RPC error response for unsupported methods or invalid parameters. On unexpected errors, returns a JSON-RPC internal error response.
    """
    try:
