...
async def mcp_handler(request: Request):
    ...
    Supported methods:
    - "initialize": Returns server metadata including name, version, and MCP version.
    - "asr_got.query": Processes a query and returns a simulated answer, reasoning trace summary, graph state, confidence vector, execution time, and session ID.
    - "shutdown": Returns a null result.
    
    Returns a JSON-RPC error response for unsupported methods, invalid parameters, or internal errors.
    """
    try:
