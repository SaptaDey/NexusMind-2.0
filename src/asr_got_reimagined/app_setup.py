...
def create_app() -> FastAPI:
    ...
    Initializes the logger, sets up CORS middleware based on allowed origins from settings, attaches a GoTProcessor instance to the app state, defines a health check endpoint, and mounts the MCP router.
