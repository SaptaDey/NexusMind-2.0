...
def create_app() -> FastAPI:
    ...
    Sets up logging, attaches the GoTProcessor to application state, configures CORS middleware based on settings, registers a health check endpoint, and mounts the MCP router. Returns the fully initialized FastAPI app.
