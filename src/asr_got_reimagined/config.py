...
class Settings(BaseSettings):
    ...
    def settings_customise_sources(
        ...
        Adds a settings source that loads from a pre-parsed YAML configuration dictionary after dotenv settings, ensuring the following precedence: initialization, environment variables, dotenv files, YAML file, and file secrets.
