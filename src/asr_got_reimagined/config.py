...
class Settings(BaseSettings):
    ...
    def settings_customise_sources(
        ...
        """
        Customizes the order of configuration sources for Pydantic settings.
        
        Inserts a YAML-based settings source, using a pre-loaded configuration dictionary, after dotenv settings in the priority order. This enables settings to be loaded from initialization, environment variables, dotenv files, the YAML file, and file secrets, in that sequence.
        
        Args:
            settings_cls: The Pydantic settings class being configured.
        
        Returns:
            A tuple of settings sources in the order they should be applied by Pydantic.
        """
        class YamlConfigSettingsSource(PydanticBaseSettingsSource):
            def __init__(self, settings_cls: Type[BaseSettings]):
                """
                Initializes the YAML settings source with the pre-loaded YAML configuration.
                
                Args:
                    settings_cls: The Pydantic BaseSettings class for which this source is being used.
                """
