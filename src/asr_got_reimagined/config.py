...
class Settings(BaseSettings):
    ...
    def settings_customise_sources(
        ...
        Adds a YAML configuration source, using a pre-loaded dictionary, after dotenv settings in the priority order. This enables settings to be loaded from initialization, environment variables, dotenv files, the YAML file, and file secrets, in that sequence.
