...
class Settings(BaseSettings):
    ...
    def settings_customise_sources(
        ...
        Inserts a YAML configuration source, using a pre-loaded dictionary, into the settings loading priority after dotenv settings. This enables layered configuration, allowing values from initialization, environment variables, dotenv files, the YAML file, and file secrets to be merged in that order.
