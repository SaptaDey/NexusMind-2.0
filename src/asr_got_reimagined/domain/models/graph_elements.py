...
class Node(TimestampedModel):
    ...
    def serialize_confidence_to_list(self, v: ConfidenceVector, _info):
        """
        Converts the ConfidenceVector to a list for serialization.
...
class Edge(TimestampedModel):
    ...
    def __hash__(self):
        ...
        This enables Edge instances to be used in hash-based collections and ensures that
        edges with the same identifiers and type are treated as equivalent for hashing purposes.
        """
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        Returns:
            True if the other object is an Edge with the same ID, source ID, target ID, and type; otherwise, False.
        """
