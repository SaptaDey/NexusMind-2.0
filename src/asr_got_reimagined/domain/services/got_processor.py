...
class GoTProcessor:
    ...
    def _initialize_stages(self) -> list[BaseStage]:
        ...
        Returns:
            A list of eight initialized stage objects, each representing a distinct step in the query processing pipeline. Logs a warning if the number of initialized stages is not eight.
        """
    ...
    async def process_query(
        ...
        This method initializes or continues a session, orchestrates the execution of all processing stages, logs detailed input and output information for each stage, handles errors (especially during initialization), and compiles the final results and metrics for the query. If a critical error occurs during initialization, processing halts early and an error message is returned.
        """
        from src.asr_got_reimagined.domain.stages import (
            CompositionStage,
    ...
    async def shutdown_resources(self):
        ...
        Currently a placeholder; no resources are managed directly by the processor.
        """
