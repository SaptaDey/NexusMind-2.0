...
def execute_query(
    ...
    Initializes the Neo4j driver with credentials from configuration if no driver exists or the existing driver is closed. Verifies connectivity upon initialization. Raises an exception if the connection cannot be established.
    """
