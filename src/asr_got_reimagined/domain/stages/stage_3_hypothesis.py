...
class HypothesisStage(BaseStage):
    ...
    def _prepare_node_properties_for_neo4j(self, node_pydantic: Node) -> Dict[str, Any]:
        ...
        Serializes confidence and metadata fields, handling datetimes, enums, lists, sets, and nested Pydantic models. Filters out properties with None values.
        """
    ...
    def _prepare_edge_properties_for_neo4j(self, edge_pydantic: Edge) -> Dict[str, Any]:
        ...
        Serializes confidence and metadata fields, handling datetimes, enums, collections, and nested Pydantic models for compatibility with Neo4j property storage. Filters out properties with None values.
        """
