...
class Logger:
    ...
    def add(self, sink: Any, **kwargs: Any) -> int:
        ...
        The sink can be a file, stream, callable, or other supported destination. Additional keyword arguments allow customization of the handler's behavior.
        
        Returns:
            An integer ID representing the added handler, which can be used for later removal.
        """
        ...
    ...
    def catch(
        ...
        """
        Decorator that wraps a callable to catch and log any exceptions it raises.
    ...
    def catch(
        ...
        *,  # Changed List to list
        ...
        Args:
            exception: List of exception types to catch. If omitted, all exceptions are caught.
