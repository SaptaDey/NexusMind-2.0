...
class Logger:
    ...
    def remove(self, handler_id: int) -> None:
        ...
        Args:
            handler_id: The integer identifier of the handler to remove.
        """
        ...

    def add(self, sink: Any, **kwargs: Any) -> int:
        """
        Adds a new logging handler that directs log messages to the specified sink.
        
        Args:
            sink: The target for log messages, which can be a file, stream, or callable.
    ...
    def catch(self, *args: Any, **kwargs: Any) -> Any:
        ...
        Returns:
            The decorated function with automatic exception logging applied.
        """
        ...  # type: ignore[empty-body]
