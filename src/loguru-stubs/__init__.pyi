...
Use this method to record events that indicate a serious error or system failure.
"""
...
    def exception(self, __message: str, *args: Any, **kwargs: Any) -> None: """
Logs a message with 'exception' severity, including exception traceback if called within an exception handler.

Args:
    __message: The message to log, supporting formatting with args and kwargs.
"""
...
...
Keyword arguments allow customization of logging behavior, such as formatting,
handlers, levels, and other logging options.
"""
...
