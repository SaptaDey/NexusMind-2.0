...
Use this method to record events that indicate a serious failure or critical error.
"""
...
...
The message can include formatting placeholders, and exception details from the current context are automatically appended.
"""
...
...
Returns:
	The handler ID assigned to the added sink.
"""
...
...
...
    ...
    def catch(
        ...
        *,
        ...
        Creates a decorator to catch specified exceptions in a function and log them.
...
Keyword arguments determine logging behavior, such as formatting, handlers, or filters.
"""
...
