...
def run_all_tests():
    ...
    Executes the initialization test, and if successful, performs the ASR query test using a generated session ID. Prints a completion message after all tests are finished.
    """
