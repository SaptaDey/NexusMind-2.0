...
def make_request(host, port, path, method="GET", body=None, headers=None):
    ...
    Prints the HTTP response status and content. Any errors encountered during the request are printed. The connection is always closed after the request completes.
    """
